    ...
    <div class="container">
        ...
        <div class="records-container">
            <c:choose>
                ...
                <c:otherwise>
                    <span>Нет никаких задач</span>
                </c:otherwise>
            </c:choose>
        </div>
        <div class="management-container">
            <form action="/add-record" method="post" class="management-form">
                <input type="text" name="title" placeholder="Добавить команду..." class="management-form__input">
                <button type="submit" class="management-form__button">Добавить</button>
            </form>
        </div>
    </div>
</div>
